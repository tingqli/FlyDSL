...
UniversalAtomic = lambda atomic_op, val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(atomic_op), val_type.ir_type, syncscope)
UniversalAtomicAdd = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Add), val_type.ir_type, syncscope)
UniversalAtomicMax = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Max), val_type.ir_type, syncscope)
UniversalAtomicMin = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Min), val_type.ir_type, syncscope)
UniversalAtomicAnd = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.And), val_type.ir_type, syncscope)
UniversalAtomicOr = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Or), val_type.ir_type, syncscope)
UniversalAtomicInc = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Inc), val_type.ir_type, syncscope)
UniversalAtomicDec = lambda val_type, syncscope="agent": CopyOpUniversalAtomicType.get(int(AtomicOp.Dec), val_type.ir_type, syncscope)
